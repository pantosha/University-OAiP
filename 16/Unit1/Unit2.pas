...
implementation
 constructor TOchered.Create(n: byte);
 var
  i: byte;
 begin
  Inherited Create;
 ...
 procedure TOchered.Push(Number: byte); // что-то надо делать с крайними.  ак лучше добавить их адреса?
 var
  ETP: PTField;
 begin
  New(ETP);
 ...
 function TOchered.Search(LookFor: byte; FP: PTField = nil): PTField;
 begin
  Result := nil;
  if EBP = nil then
   Exit;
