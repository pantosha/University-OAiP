...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Buttons, Grids, UHash;
type
  TForm1 = class(TForm)
    ...
    procedure ButMaxKeyClick(Sender: TObject);
  end;
...
procedure TForm1.ButMaxKeyClick(Sender: TObject);
var
 MaxRec: TInf;
begin
 MaxRec := T.MaxKey;
 Memo1.Clear;
 Memo1.Lines.Add('Максимальным ключом является: ' + MaxRec.FIO + ' '+ IntToStr(MaxRec.Key));
end;
